...
def deployment(spec, name, namespace, version):
    """
...
def service(name, namespace, version):
    """
...
def status(
    ...
    """
    Updates the PLC CR's status to reflect availability
    """
    ...
    try: 
        ...
        logger.exception(f"Failed to update plc status")